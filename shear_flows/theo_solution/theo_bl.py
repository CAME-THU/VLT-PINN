...
# ----------------------------------------------------------------------
# define constants
data = np.loadtxt("./Blasius.csv", delimiter=",")
...
# save_dir = f"./results/boundary_layer/Re{int(Re_x)}_U{u_far}_delta{delta}_nu{nu}/"
save_dir = f"./results/boundary_layer/"
...
# textnames = ["u", "v", "T", "um", "psi"]
# units = ["m/s", "m/s", "K", "m/s", "m2/s"]
ffs = [uu, vv, UU, psipsi]
